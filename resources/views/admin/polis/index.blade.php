...
{{-- Tombol tambah --}}
<a class="add-button" href="{{ route('admin.polis.create') }}">+ Tambah Poli</a>
...
<table>
    ...
    @forelse($polis as $poli)
        <tr>
            ...
            <td>{{ $poli->name }}</td>
            <td>
                <a href="{{ route('admin.polis.edit', $poli->id) }}">Edit</a>
    ...
    @empty
        <tr>
            <td colspan="3" style="text-align:center; color:#d63384; font-weight:bold;">
                Belum ada data poli
            </td>
        </tr>
    @endforelse
